...
//        if (StringUtils.hasText(producerKafkaProperties.getTruststoreLocation())) {
//            properties.put("ssl.truststore.location", producerKafkaProperties.getTruststoreLocation());
//            properties.put("ssl.truststore.password", producerKafkaProperties.getTruststorePassword());
//        }
    }
